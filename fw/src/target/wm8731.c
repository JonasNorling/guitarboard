...
static const uint32_t DAC_DMA_STREAM = 4;
static const uint32_t DAC_DMA_CHANNEL = 0;
...
void codecInit(void)
{
    ...
    gpio_set_output_options(GPIOB, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, GPIO12 | GPIO13 | GPIO14 | GPIO15);
